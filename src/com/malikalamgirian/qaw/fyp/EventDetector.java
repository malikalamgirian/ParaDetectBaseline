...
public class EventDetector {
    ...
    private void process() throws Exception {
        ...
        String lcsOfCharactersStr = null,
                lcsOfLexemesStr,
                lcsBasedOnTokensStr = null,
                TBALSequenceForString1Str = null,
                TBALSequenceForString2Str = null,
    ...
    private void addLBALBasedEventDetection(Document doc,
        ...
        try {
            ...
            if (isEventFoundInBowLexemesString1 == true && isEventFoundInBowLexemesString2 == true) {
                /*
                 * In case event is found in both LBAL strings
                 */
                LBALEventDetectionElement.setTextContent("true");
            } else {
                /*
                 * if not found in both strings
                 */
