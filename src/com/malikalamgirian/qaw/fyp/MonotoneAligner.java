...
//                }
     ...
     */
    private String calculateLcsOfLexemes(String lcsOfCharacters, String posFilteredStr1,
            String posFilteredStr2) throws Exception {
        /*
         * Local Declarations
         */
        String lcsOfLexemes = "",
                ...
                lexemesPosFilteredStr1[],
                lexemesPosFilteredStr2[],
                tokenForString1Lexeme,
                tokenForString2Lexeme,
                firstTwoCharactersOfPosOfString1Lexeme,
                firstTwoCharactersOfPosOfString2Lexeme;

        int indexOfLastLexemeMatchFound = 0;
...
//            tokens = lcsOfCharacters.split(tokenizerChar);
            ...
            /*
             * Get Lexemes for posFilteredStrings
             */
            lexemesPosFilteredStr1 = posFilteredStr1.split(tokenizerChar);
            lexemesPosFilteredStr2 = posFilteredStr2.split(tokenizerChar);

            /*
             * Loop dynamically through Lexemes of posFilteredStrings,
             *
             * Outer-loop for lexemesPosFilteredStr2
             */
            for (int i = 0; i < lexemesPosFilteredStr1.length; i++) {

                /*
                 * Get 'tokenForString1Lexeme' from lexemesPosFilteredStr1
                 */
                tokenForString1Lexeme = lexemesPosFilteredStr1[i].substring(0,
                        lexemesPosFilteredStr1[i].indexOf(interLexemeSeparatorCharacter));

                /*
                 * Get 'firstTwoCharactersOfPosOfString1Lexeme' from lexemesPosFilteredStr1
                 */
                firstTwoCharactersOfPosOfString1Lexeme = lexemesPosFilteredStr1[i].substring(
                        lexemesPosFilteredStr1[i].indexOf(interLexemeSeparatorCharacter) + 1,
                        lexemesPosFilteredStr1[i].indexOf(interLexemeSeparatorCharacter) + 3);

                /*
                 * Loop for lexemesPosFilteredStr2
                 *
                 * with an additional condition, for Strictly increasing order LCS
                 */
                for (int j = indexOfLastLexemeMatchFound; j < lexemesPosFilteredStr2.length; j++) {
                    /*
                     * Get 'tokenForString2Lexeme' from lexemesPosFilteredStr2
                     */
                    tokenForString2Lexeme = lexemesPosFilteredStr2[j].substring(0,
                            lexemesPosFilteredStr2[j].indexOf(interLexemeSeparatorCharacter));

                    /*
                     * Get 'firstTwoCharactersOfPosOfString2Lexeme' from lexemesPosFilteredStr2
                     */
                    firstTwoCharactersOfPosOfString2Lexeme = lexemesPosFilteredStr2[j].substring(
                            lexemesPosFilteredStr2[j].indexOf(interLexemeSeparatorCharacter) + 1,
                            lexemesPosFilteredStr2[j].indexOf(interLexemeSeparatorCharacter) + 3);

                    /*
                     * If match found, construct 'lcsOfLexemes'
                     */
                    if (tokenForString1Lexeme.equalsIgnoreCase(tokenForString2Lexeme)
                        ...
                        /*
                         * Advance the index match
                         */
                        indexOfLastLexemeMatchFound = (j + 1);

                        /*
                         * Construct lcsOfLexemes
                         */
                        if (lcsOfLexemes.equalsIgnoreCase("")) {
                            /*
                             * Case for first tokens[i]
                             */
                            lcsOfLexemes += lexemesPosFilteredStr1[i];
                        } else {
                            /*
                             * Case for other tokens[i]
                             */
                            lcsOfLexemes += tokenizerChar + lexemesPosFilteredStr1[i];
                        }
...
//                lexeme = tokens[i];
//
//                if (isLexemeContainedInLexemeBasedString(lexeme, posFilteredStr1)
//                        || isLexemeContainedInLexemeBasedString(lexeme, posFilteredStr2)) {
//                    /*
...
//            }
     ...
     */
    private String calculateLcsBasedOnTokens(String lcsOfCharacters, String posFilteredStr1,
            String posFilteredStr2) throws Exception {
        /*
         * Local Declarations
         */
    ...
    private Boolean isLexemeContainedInLexemeBasedString(String lexeme_To_Find, String lexemeBasedString) throws Exception {
        ...
        String lexemes[],
                ...
                tokenizerChar,
                tokenForLexeme,
                tokenForLexemeToFind,
                interLexemeSeparatorCharacter,
                firstTwoCharactersOfPosOfLexeme,
                firstTwoCharactersOfPosOfLexemeToFind;
        ...
        try {
            ...
            /*
             * get token For Lexeme To find , here tokenForLexemeToFind
             */
            try {

                tokenForLexemeToFind = lexeme_To_Find.substring(0, lexeme_To_Find.indexOf(interLexemeSeparatorCharacter));
                 ...
                 * that is, no '/' found.
                 */
                tokenForLexemeToFind = lexeme_To_Find;
            }

            /*
             * get first Two Characters Of Pos Of Lexeme To Find, 'firstTwoCharactersOfPosOfLexemeToFind'
             */
            try {

                firstTwoCharactersOfPosOfLexemeToFind = lexeme_To_Find.substring(lexeme_To_Find.indexOf(interLexemeSeparatorCharacter) + 1, lexeme_To_Find.indexOf(interLexemeSeparatorCharacter) + 3);

            } catch (IndexOutOfBoundsException e) {
                /*
                 * Case where, firstTwoCharactersOfPosOfLexeme does not contain POS, in token_POS
                 * that is, no '/' found.
                 */
                firstTwoCharactersOfPosOfLexemeToFind = "";
            }
            ...
            for (int i = 0; i < lexemes.length; i++) {
                ...
                /*
                 * get token For Lexeme , here tokenForLexeme
                 */
                try {

                    tokenForLexeme = lexeme.substring(0, lexeme.indexOf(interLexemeSeparatorCharacter));
                     ...
                     * that is, no '/' found.
                     */
                    tokenForLexeme = lexeme;
                }

                /*
                 * get first Two Characters Of Pos Of Lexeme, 'firstTwoCharactersOfPosOfLexeme'
                 */
                try {

                    firstTwoCharactersOfPosOfLexeme = lexeme.substring(lexeme.indexOf(interLexemeSeparatorCharacter) + 1, lexeme.indexOf(interLexemeSeparatorCharacter) + 3);
                 ...
                 *
                 * by using Token_POS, where POS check is on first two characters of POS
                 */
                if (firstTwoCharactersOfPosOfLexeme.equalsIgnoreCase(
                        firstTwoCharactersOfPosOfLexemeToFind)
                        && tokenForLexeme.equalsIgnoreCase(tokenForLexemeToFind)) {
                    /*
                     * Lexeme found
                     */
    ...
    private Boolean addLcsCalculations(Document doc, Element root, Node pair,
            String lcsOfCharacters, String lcsOfLexemes, String lcsBasedOnToken) throws Exception {
        /*
         * Local Declarations
         */
        Element lcsBase,
