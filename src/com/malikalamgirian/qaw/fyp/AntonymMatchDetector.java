    ...
    private void process() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < pairs.getLength(); i++) {
                 ...
                 */
                posFilteredString1Str = posFilteredString1.item(i).getTextContent().toLowerCase();
                posFilteredString2Str = posFilteredString2.item(i).getTextContent().toLowerCase();
                 ...
                 *
                 */
                antonymDetector(posFilteredString1Str, posFilteredString2Str,
                        str1ToStr2AntonymMatchType, tokenizerChar,
                        intraLexemeSeparatorCharacter, pair_Quality);

                antonymDetector(posFilteredString2Str, posFilteredString1Str,
