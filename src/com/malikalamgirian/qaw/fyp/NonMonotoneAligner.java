...
//            LBUnalignedLexemesSequenceForString2Element = doc.createElement("LBUnalignedLexemesSequenceForString2");
            ...
            for (int i = 0; i < lexemesString1.length; i++) {
                 ...
                 */
                firstTwoCharactersOfPosOfString1Lexeme = lexemesString1[i].substring(
                        lexemesString1[i].indexOf(interLexemeSeparatorCharacter) + 1,
                        lexemesString1[i].indexOf(interLexemeSeparatorCharacter) + 3);
